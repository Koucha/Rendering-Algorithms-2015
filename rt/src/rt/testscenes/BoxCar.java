...
public class BoxCar extends Scene {
	
	public BoxCar()
	{	
		outputFilename = new String("../output/testscenes/BoxCar");
...
//			rectangle.material = new MirrorMaterial(new Spectrum(0.8f, 0.8f, 0.8f));
		...
		try
		{
			...
			mesh.material = new Diffuse(new Spectrum(0.8f, 0.4f, 0.4f));
			timer.reset();
		...
		PointLight rectangleLight = new PointLight(bottomLeft, new Spectrum(100.f, 100.f, 100.f));
