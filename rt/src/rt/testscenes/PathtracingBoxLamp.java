...
//			rectangle.material = new MirrorMaterial(new Spectrum(0.8f, 0.8f, 0.8f));
		...
		RectangleLight rectangleLight = new RectangleLight(new Vector3f(-0.25f, 1.f, 0.25f), new Vector3f(0.5f, 0.f, 0.f), new Vector3f(0.f, 0.5f, 0.f), new Spectrum(10.f, 10.f, 10.f));
		objects.add(rectangleLight);
		lightList.add(rectangleLight);
		rectangleLight = new RectangleLight(new Vector3f(0.25f, 1.f, -0.25f), new Vector3f(-0.5f, 0.f, 0.f), new Vector3f(0.f, 0.5f, 0.f), new Spectrum(10.f, 10.f, 10.f));
		objects.add(rectangleLight);
		lightList.add(rectangleLight);
		rectangleLight = new RectangleLight(new Vector3f(-0.25f, 1.5f, 0.25f), new Vector3f(0.5f, 0.f, 0.f), new Vector3f(0.f, 0.f, -0.5f), new Spectrum(10.f, 10.f, 10.f));
		objects.add(rectangleLight);
		lightList.add(rectangleLight);
		rectangleLight = new RectangleLight(new Vector3f(-0.25f, 1.f, -0.25f), new Vector3f(0.5f, 0.f, 0.f), new Vector3f(0.f, 0.f, 0.5f), new Spectrum(10.f, 10.f, 10.f));
		objects.add(rectangleLight);
		lightList.add(rectangleLight);
		rectangleLight = new RectangleLight(new Vector3f(0.25f, 1.f, 0.25f), new Vector3f(0.f, 0.f, -0.5f), new Vector3f(0.f, 0.5f, 0.f), new Spectrum(10.f, 10.f, 10.f));
		objects.add(rectangleLight);
		lightList.add(rectangleLight);
		rectangleLight = new RectangleLight(new Vector3f(-0.25f, 1.f, -0.25f), new Vector3f(0.f, 0.f, 0.5f), new Vector3f(0.f, 0.5f, 0.f), new Spectrum(10.f, 10.f, 10.f));
		objects.add(rectangleLight);
